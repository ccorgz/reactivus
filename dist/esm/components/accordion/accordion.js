...
function Accordion(_a) {
    var title = _a.title, isOpenControl = _a.isOpenControl, setIsOpenControl = _a.setIsOpenControl, children = _a.children, alwaysOpen = _a.alwaysOpen;
    var _b = (0, react_1.useState)(isOpenControl ? isOpenControl : true), isOpen = _b[0], setIsOpen = _b[1];
    ...
    return (react_1.default.createElement("div", { className: "reactivus-accordion-main-box" },
        react_1.default.createElement("div", { className: "reactivus-accordion-header-box", onClick: function () {
            ...
            react_1.default.createElement("div", { className: "reactivus-accordion-header-title" }, title ? title : ""),
